...
folder = "E:\\python\\F4838\\data\\sh600236\\"
...
for file in filelist:
    ...
    if (df.size > 10):
        ...
        #if power > 0 :
        print (file,str(power) +"["+str(zhudong_buy)+":"+str(beidong_buy)+"]"+ "\t"+str(mf)+"\t"+str(ic)+"\t"+ str(p_all_vol) +"\t"+str(all_buy_vol)+"\t"+str(all_sell_vol)+"\t"+ "\t"+ str(small_bill_cha) + "\t"+str(small_bill_buy)+"\t ["+str(m_b)+","+str(m_e)+","+str(a_b)+","+str(a_e)+"]" +str(small_rate)) 
